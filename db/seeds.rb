...
Prenda.create(tipo: :remera, categoria: :hombre, material: :algodon, color_primario: '#424BF5', color_secundario: '#CC0066')
...
#Prenda.create! tipo: :remera, categoria: :hombre, material: :algodon, color_primari